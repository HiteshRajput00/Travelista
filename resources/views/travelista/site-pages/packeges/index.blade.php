            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <p class="text-white link-nav"><a href="index.html">Home </a> <span class="lnr lnr-arrow-right"></span> <a
                            href="packages.html"> Tour Packages</a></p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-10 active-hot-deal-carusel">
                    <div class="single-carusel">
                        <div class="thumb relative">
                            <div class="overlay overlay-bg"></div>
                            <img class="img-fluid" src="{{ url('/travelista/img/packages/hot-deal.jpg') }}" alt="">
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-destinations">
                        <div class="thumb">
                            <img src="{{ url('/travelista/img/packages/d1.jpg') }}" alt="">
                        </div>
                        <div class="details">
                ...
                <div class="col-lg-4">
                    <div class="single-destinations">
                        <div class="thumb">
                            <img src="{{ url('/travelista/img/packages/d2.jpg') }}" alt="">
                        </div>
                        <div class="details">
                            <h4>Holiday Sea beach Blue Ocean</h4>
                            <p>
                ...
                <div class="col-lg-4">
                    <div class="single-destinations">
                        <div class="thumb">
                            <img src="{{ url('/travelista/img/packages/d3.jpg') }}" alt="">
                        </div>
                        <div class="details">
                            <h4>Holiday Sea beach Blue Ocean</h4>
                            <p>
                ...
                <div class="col-lg-4">
                    <div class="single-destinations">
                        <div class="thumb">
                            <img src="{{ url('/travelista/img/packages/d4.jpg') }}" alt="">
                        </div>
                        <div class="details">
                            <h4>Holiday Sea beach Blue Ocean</h4>
                            <p>
                ...
                <div class="col-lg-4">
                    <div class="single-destinations">
                        <div class="thumb">
                            <img src="{{ url('/travelista/img/packages/d5.jpg') }}" alt="">
                        </div>
                        <div class="details">
                            <h4>Holiday Sea beach Blue Ocean</h4>
                            <p>
                ...
                <div class="col-lg-4">
                    <div class="single-destinations">
                        <div class="thumb">
                            <img src="{{ url('/travelista/img/packages/d6.jpg') }}" alt="">
                        </div>
                        <div class="details">
                            <h4>Holiday Sea beach Blue Ocean</h4>
                            <p>
        ...
        <div class="container-fluid">
            <div class="row align-items-center justify-content-end">
                ...
                <div class="col-lg-6 col-md-12 home-about-right no-padding">
                    <img class="img-fluid" src="{{ url('/travelista/img/packages/about-img.jpg') }}" alt="">
                </div>
            </div>
        </div>
    </section>
