                            ...
                            <a href="#" target="_blank">
                                <div class="thumb">
                                    <img class="content-image img-fluid d-block mx-auto"
                                        src="{{ url('/travelista/img/blog/cat-widget1.jpg') }}" alt="">
                                </div>
                    ...
                    <div class="single-cat-widget">
                        <div class="content relative">
                            ...
                            <a href="#" target="_blank">
                                <div class="thumb">
                                    <img class="content-image img-fluid d-block mx-auto"
                                        src="{{ url('/travelista/img/blog/cat-widget2.jpg') }}" alt="">
                                </div>
                                <div class="content-details">
                    ...
                    <div class="single-cat-widget">
                        <div class="content relative">
                            ...
                            <a href="#" target="_blank">
                                <div class="thumb">
                                    <img class="content-image img-fluid d-block mx-auto"
                                        src="{{ url('/travelista/img/blog/cat-widget3.jpg') }}" alt="">
                                </div>
                                <div class="content-details">
            ...
            <div class="row">
                <div class="col-lg-8 posts-list">
                    <div class="single-post row">
                        ...
                        <div class="col-lg-9 col-md-9 ">
                            <div class="feature-img">
                                <img class="img-fluid" src="{{ url('/travelista/img/blog/feature-img1.jpg') }}"
                                    alt="">
                            </div>
                    ...
                    <div class="single-post row">
                        ...
                        <div class="col-lg-9 col-md-9 ">
                            <div class="feature-img">
                                <img class="img-fluid" src="{{ url('/travelista/img/blog/feature-img2.jpg') }}"
                                    alt="">
                            </div>
                            <a class="posts-title" href="blog-single.html">
                    ...
                    <div class="single-post row">
                        ...
                        <div class="col-lg-9 col-md-9">
                            <div class="feature-img">
                                <img class="img-fluid" src="{{ url('/travelista/img/blog/feature-img3.jpg') }}"
                                    alt="">
                            </div>
                            <a class="posts-title" href="blog-single.html">
                    ...
                    <div class="single-post row">
                        ...
                        <div class="col-lg-9 col-md-9">
                            <div class="feature-img">
                                <img class="img-fluid" src="{{ url('/travelista/img/blog/feature-img4.jpg') }}"
                                    alt="">
                            </div>
                            <a class="posts-title" href="blog-single.html">
                                <h3>The Night Sky</h3>
                    ...
                    <div class="single-post row">
                        ...
                        <div class="col-lg-9 col-md-9">
                            <div class="feature-img">
                                <img class="img-fluid" src="{{ url('/travelista/img/blog/feature-img5.jpg') }}"
                                    alt="">
                            </div>
                            <a class="posts-title" href="blog-single.html">
                    ...
                    <div class="widget-wrap">
                        ...
                        <div class="single-sidebar-widget popular-post-widget">
                            ...
                            <div class="popular-post-list">
                                <div class="single-post-list d-flex flex-row align-items-center">
                                    <div class="thumb">
                                        <img class="img-fluid" src="{{ url('/travelista/img/blog/pp1.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="details">
                                ...
                                <div class="single-post-list d-flex flex-row align-items-center">
                                    <div class="thumb">
                                        <img class="img-fluid" src="{{ url('/travelista/img/blog/pp2.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="details">
                                        <a href="blog-single.html">
                                ...
                                <div class="single-post-list d-flex flex-row align-items-center">
                                    <div class="thumb">
                                        <img class="img-fluid" src="{{ url('/travelista/img/blog/pp3.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="details">
                                        <a href="blog-single.html">
                                ...
                                <div class="single-post-list d-flex flex-row align-items-center">
                                    <div class="thumb">
                                        <img class="img-fluid" src="{{ url('/travelista/img/blog/pp4.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="details">
                                        <a href="blog-single.html">
                        ...
                        <div class="single-sidebar-widget ads-widget">
                            <a href="#"><img class="img-fluid"
                                    src="{{ url('/travelista/img/blog/ads-banner.jpg') }}" alt=""></a>
                        </div>
