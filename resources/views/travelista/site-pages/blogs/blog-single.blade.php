            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <p class="text-white link-nav"><a href="index.html">Home </a> <span class="lnr lnr-arrow-right"></span><a
                            href="blog-home.html">Blog </a> <span class="lnr lnr-arrow-right"></span> <a
                            href="blog-single.html"> Blog Details Page</a></p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="single-post row">
                        <div class="col-lg-12">
                            <div class="feature-img">
                                <img class="img-fluid" src="{{ url('/travelista/img/blog/feature-img1.jpg') }}" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row mt-30 mb-30">
                                <div class="col-6">
                                    <img class="img-fluid" src="{{ url('/travelista/img/blog/post-img1.jpg') }}" alt="">
                                </div>
                                <div class="col-6">
                                    <img class="img-fluid" src="{{ url('/travelista/img/blog/post-img2.jpg') }}" alt="">
                                </div>
                    ...
                    <div class="navigation-area">
                        <div class="row">
                            <div
                                ...
                                <div class="thumb">
                                    <a href="#"><img class="img-fluid" src="{{ url('/travelista/img/blog/prev.jpg') }}" alt=""></a>
                                </div>
                                <div class="arrow">
                            ...
                            <div
                                ...
                                <div class="thumb">
                                    <a href="#"><img class="img-fluid" src="{{ url('/travelista/img/blog/next.jpg') }}" alt=""></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="comments-area">
                        ...
                        <div class="comment-list">
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="{{ url('/travelista/img/blog/c1.jpg') }}" alt="">
                                    </div>
                                    <div class="desc">
                        ...
                        <div class="comment-list left-padding">
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="{{ url('/travelista/img/blog/c2.jpg') }}" alt="">
                                    </div>
                                    <div class="desc">
                        ...
                        <div class="comment-list left-padding">
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="{{ url('/travelista/img/blog/c3.jpg') }}" alt="">
                                    </div>
                                    <div class="desc">
                        ...
                        <div class="comment-list">
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="{{ url('/travelista/img/blog/c4.jpg') }}" alt="">
                                    </div>
                                    <div class="desc">
                        ...
                        <div class="comment-list">
                            <div class="single-comment justify-content-between d-flex">
                                <div class="user justify-content-between d-flex">
                                    <div class="thumb">
                                        <img src="{{ url('/travelista/img/blog/c5.jpg') }}" alt="">
                                    </div>
                                    <div class="desc">
                ...
                <div class="col-lg-4 sidebar-widgets">
                    <div class="widget-wrap">
                        ...
                        <div class="single-sidebar-widget popular-post-widget">
                            ...
                            <div class="popular-post-list">
                                <div class="single-post-list d-flex flex-row align-items-center">
                                    <div class="thumb">
                                        <img class="img-fluid" src="{{ url('/travelista/img/blog/pp1.jpg') }}" alt="">
                                    </div>
                                    <div class="details">
                                ...
                                <div class="single-post-list d-flex flex-row align-items-center">
                                    <div class="thumb">
                                        <img class="img-fluid" src="{{ url('/travelista/img/blog/pp2.jpg') }}" alt="">
                                    </div>
                                    <div class="details">
                                        <a href="blog-single.html">
                                ...
                                <div class="single-post-list d-flex flex-row align-items-center">
                                    <div class="thumb">
                                        <img class="img-fluid" src="{{ url('/travelista/img/blog/pp3.jpg') }}" alt="">
                                    </div>
                                    <div class="details">
                                        <a href="blog-single.html">
                                ...
                                <div class="single-post-list d-flex flex-row align-items-center">
                                    <div class="thumb">
                                        <img class="img-fluid" src="{{ url('/travelista/img/blog/pp4.jpg') }}" alt="">
                                    </div>
                                    <div class="details">
                                        <a href="blog-single.html">
                        ...
                        <div class="single-sidebar-widget ads-widget">
                            <a href="#"><img class="img-fluid" src="{{ url('/travelista/img/blog/ads-banner.jpg') }}" alt=""></a>
                        </div>
