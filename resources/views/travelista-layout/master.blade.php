...
<head>
    ...
    <!-- Favicon-->
    <link rel="shortcut icon" href="{{url('/travelista/img/fav.png')}}">
    <!-- Author Meta -->
...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
   ...
   ============================================= -->
    ...
    <link rel="stylesheet" href="{{url('/travelista/css/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{url('/travelista/css/jquery-ui.css')}}">
    <link rel="stylesheet" href="{{url('/travelista/css/nice-select.css')}}">
...
<body>
    <header id="header">
        ...
        <div class="container main-menu">
            <div class="row align-items-center justify-content-between d-flex">
                <div id="logo">
                    <a href="index.html"><img src="{{url('/travelista/img/logo.png')}}" alt="" title="" /></a>
                </div>
                ...
                <div class="col-lg-3  col-md-6 col-sm-6">
                    <div class="single-footer-widget mail-chimp">
                        ...
                        <ul class="instafeed d-flex flex-wrap">
                            <li><img src="{{url('/travelista/img/i1.jpg')}}" alt=""></li>
                            <li><img src="{{url('/travelista/img/i2.jpg')}}" alt=""></li>
                            <li><img src="{{url('/travelista/img/i3.jpg')}}" alt=""></li>
                            <li><img src="{{url('/travelista/img/i4.jpg')}}" alt=""></li>
                            <li><img src="{{url('/travelista/img/i5.jpg')}}" alt=""></li>
                            <li><img src="{{url('/travelista/img/i6.jpg')}}" alt=""></li>
                            <li><img src="{{url('/travelista/img/i7.jpg')}}" alt=""></li>
                            <li><img src="{{url('/travelista/img/i8.jpg')}}" alt=""></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <script src="{{url('/travelista/js/jquery.ajaxchimp.min.js')}}"></script>
    <script src="{{url('/travelista/js/jquery.magnific-popup.min.js')}}"></script>
